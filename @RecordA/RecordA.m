classdef RecordA
    ...
    properties (Dependent = true, SetAccess = 'protected')
        ...
        MaxTime % Time at the end of the file in Second. The maxmum of Start property of Chan objects in Chans property.
        Duration % in second
    ...
    properties (Dependent = true, SetAccess = 'public')
        Start % Time at the beginning of the file in Second. The minimum of Start property of Chan objects in Chans property.
...
%         end
        ...
        function Start = get.Start(obj)            
            ...
            st = NaN(length(obj.Chans),1);
            for i = 1:length(obj.Chans)
                st(i) = obj.Chans{i}.Start;
            end
        ...
        function maxTime = get.MaxTime(obj)
            ...
            mt = NaN(length(obj.Chans),1);
            for i = 1:length(obj.Chans)
                mt(i) = obj.Chans{i}.MaxTime;
            end
...
%         end
        ...
        function obj = set.Start(obj, newStart)
            ...
            % Using this method will make Start property of the Chan
            % objects in Chans identical.
            %
            %% parse
            p = inputParser;
    ...
    methods (Static)
        ...
        rec = readsmr(CEDS64MLpath,smrfilename,FsEvent)
