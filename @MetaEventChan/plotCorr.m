function out = plotCorr(obj, trigger, width, binsize, offset, varargin)
%% input arguments
...
out = K_PSTHcorr(obj.Data, trigger.Data, obj.SInterval, width, binsize, ...
    offset,'Mode',Mode,varargin{:});
end