function [xnames, xnamesfull, xdatenum] = pvt_getNamesDatanum(xdir, affix)
% [xnames, xnamesfull, xdatenum] = pvt_getNamesDatanum(xdir, affix)
% 
% INPUT ARGUMENTS
...
%
% OUTPUT ARGUMENTS
% xnames    File names (column of cell array) without affix
% xnamesfull
