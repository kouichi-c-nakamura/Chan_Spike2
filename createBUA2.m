function [BUA,sig,spikeTrain,indstart,befp,aftp] = createBUA2(rawsig,spikeTimes, rate, varargin)
% createBUA2 is essentially createBUA by Izhar Bar-Gad, but returns befp
% and aftp as well. Also inputParser is added for input validation. % Kouichi
%
% [BUA, sig, spikeTrain, indstart, befp, aftp] = createBUA2(rawsig,spikeTimes, rate, varargin)
...
%
%% added by Kouichi
% befp,aftp     The inserts are from spikeTrain - befp to spikeTrain + aftp
%               The length of inserts is befp + aftp + 1
%
% Original written by Izhar Bar-Gad
...
%
% Modified by Kouichi C. Nakamura Ph.D.
% MRC Brain Network Dynamics Unit
% University of Oxford
% kouichi.c.nakamura@gmail.com
% 21-Jun-2016 05:11:33
...
%%
    ...
    spikeTrain = round(spikeTimes*rate) + 1;% KOUICHI added 1
